...
TOPICS = ["The Start and Restart of Play", "Ball in Play"]
...
def build(base):
    ...
    practice = (
        ...
        '<p>Mixed shows ten questions from both topics. Choosing a topic shows its full set.</p></div></aside>'
        '<div class="quiz-list" id="quiz" aria-live="polite"><p class="quiz-count" id="quiz-count">All questions</p>'
        + question_cards + '</div></section>'
    )
    (ROOT/'practice-tests.html').write_text(shell('Free football referee quiz','Study 2026/27 Law 8 and Law 9 match scenarios by topic or mixed quiz. Reveal each decision and check the official IFAB Laws.','/practice-tests.html',base,practice,'<script src="/assets/quiz.js" defer></script>'),encoding='utf-8')
