...
def build(base):
    ...
    (ROOT/'practice-tests.html').write_text(shell('Free football referee quiz','Study 2026/27 Law 8, Law 9, Law 10, Law 11 and Law 12 match scenarios by topic or mixed quiz. Reveal each decision and check the official IFAB Laws.','/practice-tests.html',base,practice,'<script type="module" src="/assets/quiz.js?v=20260924-progress-views"></script>'),encoding='utf-8')
